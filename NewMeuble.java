...
public class NewMeuble extends JFrame {
	...
	public NewMeuble(){
		...
		this.pieceText = new JTextField();
		this.pieceLabel = new JLabel("Piece *");
		this.numberText = new JTextField();
		this.numberLabel = new JLabel("Quantité");
		this.volumeText = new JTextField();
		...
		this.detachableText = new JTextField();
		...
		this.volumeAfterText = new JTextField();
		...
		this.tittle = new JLabel("Ajouter Meuble");
		...
		ControleurNewMeuble ctrl  = new ControleurNewMeuble(this);
		this.retour.addActionListener(ctrl);
		this.enregistrer.addActionListener(ctrl);
		ControleurNewMeubleCheckbox ctrl_2 = new ControleurNewMeubleCheckbox(this);
